...
* [`src/megalan2021/`](src/megalan2021/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/megalan2021/core.cljs): contains the SPA entry point, `init`
* [`test/megalan2021/`](test/megalan2021/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `megalan2021` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/megalan2021/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns megalan2021.example
  (:require [megalan2021.config :as config])
